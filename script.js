...
const translations = {
    'en': {
        ...
        // FPH Prep section
        'fph_title': 'FPH Prep - Smart Preparation for the FPH Offizin Exam',
        'fph_description': 'The digital platform for Swiss pharmacists preparing for the federal FPH Offizin exam with realistic simulations, personalized statistics, and multilingual support.',
        'fph_access': 'Start Preparing',
        'fph_feature_sim_title': 'Realistic Simulations',
        'fph_feature_sim_description': 'Practice with multiple-choice and K-PRIM questions that faithfully mirror the official FPH Offizin exam.',
        'fph_feature_areas_title': '9 Subject Areas',
        'fph_feature_areas_description': 'Full coverage of the FPH curriculum: pharmacology, legislation, galenics, counseling, and much more.',
        'fph_feature_stats_title': 'Advanced Statistics',
        'fph_feature_stats_description': 'Detailed performance analysis with weak-point identification and improvement trends.',
        'fph_feature_lang_title': 'Multilingual',
        'fph_feature_lang_description': 'Platform available in Italian, German, French, and English for all Swiss pharmacists.',
        'fph_feature_progress_title': 'Progress Tracking',
        'fph_feature_progress_description': 'Monitor completed simulations, scores, and your preparation journey over time.',
        'fph_feature_premium_title': 'Premium Access',
        'fph_feature_premium_description': 'Flexible subscription with unlimited access to all simulations and regularly updated content.',
        'fph_cta_title': 'Ready to Pass the FPH Exam?',
        'fph_cta_description': 'Join Swiss pharmacists preparing with FPH Prep.',
        'fph_cta_button': 'Start Now',
    ...
    'it': {
        ...
        // FPH Prep section
        'fph_title': 'FPH Prep - Preparazione Intelligente per l\'Esame FPH Offizin',
        'fph_description': 'La piattaforma digitale per i farmacisti svizzeri che vogliono prepararsi all\'esame federale FPH Offizin con simulazioni realistiche, statistiche personalizzate e supporto multilingua.',
        'fph_access': 'Inizia la Preparazione',
        'fph_feature_sim_title': 'Simulazioni Realistiche',
        'fph_feature_sim_description': 'Esercitati con domande multiple-choice e K-PRIM che rispecchiano fedelmente l\'esame ufficiale FPH Offizin.',
        'fph_feature_areas_title': '9 Aree Tematiche',
        'fph_feature_areas_description': 'Copertura completa del curriculum FPH: farmacologia, legislazione, galenica, counseling e molto altro.',
        'fph_feature_stats_title': 'Statistiche Avanzate',
        'fph_feature_stats_description': 'Analisi dettagliata delle tue performance con identificazione dei punti deboli e trend di miglioramento.',
        'fph_feature_lang_title': 'Multilingua',
        'fph_feature_lang_description': 'Piattaforma disponibile in italiano, tedesco, francese e inglese per tutti i farmacisti svizzeri.',
        'fph_feature_progress_title': 'Tracking Progressi',
        'fph_feature_progress_description': 'Monitora le simulazioni completate, i punteggi ottenuti e il tuo percorso di preparazione nel tempo.',
        'fph_feature_premium_title': 'Accesso Premium',
        'fph_feature_premium_description': 'Abbonamento flessibile con accesso illimitato a tutte le simulazioni e i contenuti aggiornati.',
        'fph_cta_title': 'Pronto a Superare l\'Esame FPH?',
        'fph_cta_description': 'Unisciti ai farmacisti svizzeri che si preparano con FPH Prep.',
        'fph_cta_button': 'Inizia Ora',
    ...
    'fr': {
        ...
        // FPH Prep section
        'fph_title': 'FPH Prep - Préparation Intelligente pour l\'Examen FPH Officine',
        'fph_description': 'La plateforme digitale pour les pharmaciens suisses qui souhaitent se préparer à l\'examen fédéral FPH Officine avec des simulations réalistes, des statistiques personnalisées et un support multilingue.',
        'fph_access': 'Commencer la Préparation',
        'fph_feature_sim_title': 'Simulations Réalistes',
        'fph_feature_sim_description': 'Entraînez-vous avec des questions à choix multiples et K-PRIM qui reproduisent fidèlement l\'examen officiel FPH Officine.',
        'fph_feature_areas_title': '9 Domaines Thématiques',
        'fph_feature_areas_description': 'Couverture complète du programme FPH : pharmacologie, législation, galénique, conseil et bien plus encore.',
        'fph_feature_stats_title': 'Statistiques Avancées',
        'fph_feature_stats_description': 'Analyse détaillée de vos performances avec identification des points faibles et tendances d\'amélioration.',
        'fph_feature_lang_title': 'Multilingue',
        'fph_feature_lang_description': 'Plateforme disponible en italien, allemand, français et anglais pour tous les pharmaciens suisses.',
        'fph_feature_progress_title': 'Suivi des Progrès',
        'fph_feature_progress_description': 'Suivez les simulations complétées, les scores obtenus et votre parcours de préparation dans le temps.',
        'fph_feature_premium_title': 'Accès Premium',
        'fph_feature_premium_description': 'Abonnement flexible avec accès illimité à toutes les simulations et contenus régulièrement mis à jour.',
        'fph_cta_title': 'Prêt à Réussir l\'Examen FPH ?',
        'fph_cta_description': 'Rejoignez les pharmaciens suisses qui se préparent avec FPH Prep.',
        'fph_cta_button': 'Commencer Maintenant',
    ...
    'de': {
        ...
        // FPH Prep section
        'fph_title': 'FPH Prep - Intelligente Vorbereitung auf die FPH-Offizin-Prüfung',
        'fph_description': 'Die digitale Plattform für Schweizer Apotheker, die sich mit realistischen Simulationen, personalisierten Statistiken und mehrsprachigem Support auf die eidgenössische FPH-Offizin-Prüfung vorbereiten möchten.',
        'fph_access': 'Vorbereitung Starten',
        'fph_feature_sim_title': 'Realistische Simulationen',
        'fph_feature_sim_description': 'Üben Sie mit Multiple-Choice- und K-PRIM-Fragen, die die offizielle FPH-Offizin-Prüfung originalgetreu widerspiegeln.',
        'fph_feature_areas_title': '9 Themenbereiche',
        'fph_feature_areas_description': 'Vollständige Abdeckung des FPH-Lehrplans: Pharmakologie, Gesetzgebung, Galenische Pharmazie, Beratung und vieles mehr.',
        'fph_feature_stats_title': 'Erweiterte Statistiken',
        'fph_feature_stats_description': 'Detaillierte Leistungsanalyse mit Identifizierung von Schwachstellen und Verbesserungstrends.',
        'fph_feature_lang_title': 'Mehrsprachig',
        'fph_feature_lang_description': 'Plattform auf Italienisch, Deutsch, Französisch und Englisch für alle Schweizer Apotheker verfügbar.',
        'fph_feature_progress_title': 'Fortschrittsverfolgung',
        'fph_feature_progress_description': 'Verfolgen Sie abgeschlossene Simulationen, erzielte Punktzahlen und Ihren Vorbereitungsweg im Laufe der Zeit.',
        'fph_feature_premium_title': 'Premium-Zugang',
        'fph_feature_premium_description': 'Flexibles Abonnement mit unbegrenztem Zugang zu allen Simulationen und regelmäßig aktualisierten Inhalten.',
        'fph_cta_title': 'Bereit, die FPH-Prüfung zu bestehen?',
        'fph_cta_description': 'Schließen Sie sich Schweizer Apothekern an, die sich mit FPH Prep vorbereiten.',
        'fph_cta_button': 'Jetzt Starten',
